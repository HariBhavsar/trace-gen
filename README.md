...
3. BBV output file generation
    ...
    - Exact command ran: `export OMP_NUM_THREADS=1 && valgrind --tool=exp-bbv --interval-size=300
    000'000 --bb-out-file=BBVs/pr-twitter/pr-twitter.out ./gapbs/pr -f ./gapbs/benchmark/graphs/twitter.sg -i1000 -t1e-4 -n2 && export OMP_NUM_THREADS=96`
