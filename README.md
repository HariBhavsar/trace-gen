...
5. Tracer
    ...
    - General command is `$PIN_ROOT/pin -t $CHAMPSIM_ROOT/tracer/pin/obj-intel64/champsim_tracer.so -o [TRACE_FILE_NAME] -s [FAST_FORWARD_INSTRUCTIONS] [INTERVAL_SIZE] -- [PROGRAM_FILE] [BENCHMARK_FILE] && xz [TRACE_FILE_NAME] &`
        - Exact command: `export OMP_NUM_THREADS=1 && $PIN_ROOT/pin -t $CHAMPSIM_ROOT/tracer/pin/obj-intel64/champsim_tracer.so -o pr-twitter-1.out -s 80400000000 -t 300000000 -- ./gapbs/pr -f ./gapbs/benchmark/graphs/twitter.sg -i1000 -t1e-4 -n2 && xz pr-twitter-1.out && export OMP_NUM_THREADS=96`
# Errors
